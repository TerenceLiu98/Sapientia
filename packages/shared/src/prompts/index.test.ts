...
describe("loadPrompt", () => {
	...
	it("returns the concept-source-description-v1 template", () => {
		...
		expect(template).toContain("Output exactly one concepts[] item")
		expect(template).toContain("Context: problem, gap, motivation")
	...
	it("returns the note-concept-extract-v1 template", () => {
		...
		expect(template).toContain('"existingConceptSignals"')
		expect(template).toContain('"discoveredConcepts"')
		expect(template).toContain('"questions"')
		expect(template).toContain("Evidence blocks")
		expect(template).toContain("bridge axis")
		expect(template).toContain("alternative implementation")
		expect(template).toContain("Do not collapse across abstraction levels")
		expect(template).toContain("The paper does not discuss X")
