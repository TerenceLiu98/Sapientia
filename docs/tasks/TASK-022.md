...
**Remaining effort**: closed; optional heavier flow coverage can move to follow-up
...
**Status**: ✅ Closed — note-native Ask checkpoint
...
TASK-022 is closed as the note-native Ask foundation card.
